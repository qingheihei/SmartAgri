...
class Thing(models.Model):
    ...
    house = models.ForeignKey(House, on_delete=models.CASCADE, related_name="things")
...
class Sensor(models.Model):
    ...
    thing = models.ForeignKey(Thing, on_delete=models.CASCADE, related_name="sensors")
...
class Machine(models.Model):
    ...
    house = models.ForeignKey(House, on_delete=models.CASCADE, related_name="machines")
    maker = models.CharField(max_length=64)
    model_code = models.CharField(max_length=64)
